...
class PayloadTest(BaseTest):
  ...
  def test_wrong_fingerprinted_field(self):
    with self.assertRaises(FingerprintedField.MustBeFingerprintedError):
      FingerprintedField("wrong-type")
